      ...
      <b-form @submit.prevent>
        <b-row>
          ...
          <b-col md="4">
            <b-form-group
              label="CNPJ"
              label-for="myinfo-identificationNo"
            >
              <b-form-input
