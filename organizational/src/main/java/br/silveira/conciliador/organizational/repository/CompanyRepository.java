...
public interface CompanyRepository extends MongoRepository<Company, String> {
	...
	public Optional<Company> findCompanyCostValuesByIdAndMktPlaceAndFeeType(String companyId, MktPlaceEnum marketPlace,
			String feeType);
	...
	public Optional<Company> findCompanyCostValuesByIdAndMktPlaceAndFeeTypeAndSku(String companyId,
			MktPlaceEnum marketPlace, String feeType, List<String> sku);
	...
	@Query(value = "{ id : ?0 }", fields = "{ id : 1 , identificationNo : 1 ,  shortName : 1 ,  fixedCost : 1  }")
	public Optional<Company> findFixedCostById(String id);
